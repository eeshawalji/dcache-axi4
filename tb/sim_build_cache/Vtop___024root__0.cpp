...
extern const VlUnpacked<CData/*2:0*/, 128> Vtop__ConstPool__TABLE_h2ceff150_0;
...
void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.tb_top__DOT__u_dcache__DOT__mem_req_be 
        = (- (IData)((2U == (IData)(vlSelfRef.tb_top__DOT__u_dcache__DOT__state))));
    ...
    vlSelfRef.tb_top__DOT__u_dcache__DOT__next_state 
        = Vtop__ConstPool__TABLE_h2ceff150_0[((((IData)(vlSelfRef.tb_top__DOT__u_dcache__DOT__victim_dirty) 
                                                << 6U) 
...
void Vtop___024root___nba_sequent__TOP__2(Vtop___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((((IData)(vlSelfRef.tb_top__DOT__u_dcache__DOT__rst_n) 
                      ...
                      & (IData)(vlSelfRef.tb_top__DOT__u_dcache__DOT__miss))))) {
        VL_WRITEF_NX("[%0t] %%Error: dcache.sv:304: Assertion failed in %m: dcache: miss immediately after fill -- the fill did not take\n",3, 'M',vlSymsp->name(),"tb_top.u_dcache", 'T',-9
                     , '#',64,VL_TIME_UNITED_Q(1000));
        VL_STOP_MT("/home/eeshawalji/dcache/tb/../hdl/dcache.sv", 304, "");
    }
    ...
    if ((0x000000000000000fULL & vlSelfRef.__VnbaTriggered[0U])) {
        {
            ...
            vlSelfRef.tb_top__DOT__u_dcache__DOT__next_state 
                = Vtop__ConstPool__TABLE_h2ceff150_0
                [((((IData)(vlSelfRef.tb_top__DOT__u_dcache__DOT__victim_dirty) 
                    << 6U) | ((IData)(vlSelfRef.tb_top__DOT__u_dcache__DOT__miss) 
                              << 5U)) | (((IData)(vlSelfRef.tb_top__DOT__u_dcache__DOT__mem_req_ready) 
                                          << 4U) | 
                                         (((IData)(vlSelfRef.tb_top__DOT__u_dcache__DOT__mem_resp_valid) 
                                           << 3U) | (IData)(vlSelfRef.tb_top__DOT__u_dcache__DOT__state))))];
        }
